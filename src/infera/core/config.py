...
class ResourceSpec(BaseModel):
    ...
    depends_on: list[str] = Field(default_factory=list, description="Resource IDs this depends on")
...
class InferaConfig(BaseModel):
    ...
    # Architecture
    architecture_type: str | None = None  # static_site, api_service, fullstack_app, etc.
